        ...
        <li>
          <div className="flex flex-col sm:block">
            ...
            <span className="order-1 block">
              ...
              serialization, editor tooling, and native C++ DLL scripting.
              Built a community and hosted multiple hackathons around it.
            </span>
          </div>
        </li>
        <li>
          <div className="flex flex-col sm:block">
            ...
            <span className="order-1 block">
              ...
              character encoding from ASCII and porting various native
              applications to their new GUI markup language.
            </span>
          </div>
        </li>
        <li>
